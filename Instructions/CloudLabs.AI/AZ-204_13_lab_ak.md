...
1.  On the **Basics** tab, perform the following actions:
    ...
    1.  In the **Resource group** section, select use existing, enter **MarketingContent-[deployId]**, and then select **OK**.

    1.  In the **Storage account name** text box, enter **contenthost*[deployId]***.
...
1.  On the **Basics** tab, perform the following actions:
    ...
    1.  In the **Resource group** section, select **MarketingContent-[deployId]**.

    1.  In the **Name** text box, enter **landingpage*[deployId]***.
...
1.  On the **Resource groups** blade, select the **MarketingContent-[deployId]** resource group.

1.  On the **MarketingContent-[deployId]** blade, select the **landingpage*[deployId]*** web app that you created earlier in this lab.
...
1.  On the **MarketingContent-[deployId]** blade, select the **contenthost*[deployId]*** storage account that you created earlier in this lab.
...
1.  On the **Resource groups** blade, find and then select the **MarketingContent-[deployId]** resource group.

1.  On the **MarketingContent-[deployId]** blade, select the **contentdeliverynetwork** CDN profile that you created earlier in this lab.

1.  On the **CDN profile** blade, select **+ Endpoint**.

1.  In the **Add an endpoint** pop-up dialog box, perform the following actions:

    1.  In the **Name** text box, enter **cdnmedia*[deployId]***.

    1.  In the **Origin type** drop-down list, select **Storage**.

    1.  In the **Origin hostname** drop-down list, select the **contenthost*[deployId]*.blob.core.windows.net** option for the Storage account that you created earlier in this lab.
...
1.  In the **Add an endpoint** pop-up dialog box, perform the following actions:
    ...
    1.  In the **Name** text box, enter **cdnvideo*[deployId]***.
...
1.  In the **Add an endpoint** pop-up dialog box, perform the following actions:
    ...
    1.  In the **Name** text box, enter **cdnweb*[deployId]***.

    1.  In the **Origin type** drop-down list, select **Web App**.

    1.  In the **Origin hostname** drop-down list, select the **landingpage*[deployId]*.azurewebsites.net** option for the Web App that you created earlier in this lab.
...
1.  In the **Configuration** section, perform the following actions:
    ...
    1.  In the **Value** text box, enter the **URI** value of the **media** container in the **contenthost*[deployId]*** storage account that you recorded earlier in this lab.
    ...
    1.  In the **Value** text box, enter the **URI** value of the **video** container in the **contenthost*[deployId]*** storage account that you recorded earlier in this lab.
...
1.  On the **CDN profile** blade, select the **cdnmedia*[deployId]*** endpoint.
...
1.  Back on the **CDN profile** blade, select the **cdnvideo*[deployId]*** endpoint.
...
1.  Construct a URL for the **campus.jpg** resource by combining the **Endpoint hostname** URL from the **cdnmedia*[deployId]*** endpoint that you copied earlier in the lab with a relative path of **/campus.jpg**.
...
1.  Construct a URL for the **conference.jpg** resource by combining the **Endpoint hostname** URL from the **cdnmedia*[deployId]*** endpoint that you copied earlier in the lab with a relative path of **/conference.jpg**.
...
1.  Construct a URL for the **poster.jpg** resource by combining the **Endpoint hostname** URL from the **cdnmedia*[deployId]*** endpoint that you copied earlier in the lab with a relative path of **/poster.jpg**.
...
1.  Construct a URL for the **welcome.mp4** resource by combining the **Endpoint hostname** URL from the **cdnvideo*[deployId]*** endpoint that you copied earlier in the lab with a relative path of **/welcome.mp4**.
...
1.  In the **Configuration** section, perform the following actions:
    ...
    1.  In the **Add/Edit application setting** pop-up dialog box, update the **Value** text box by entering the **Endpoint hostname** URL from the **cdnmedia*[deployId]*** endpoint that you copied earlier in the lab, and then select **OK**.
    
    1.  Select the existing **CDNVideoEndpoint** application setting.

    1.  In the **Add/Edit application setting** pop-up dialog box, update the **Value** text box by entering the **Endpoint hostname** URL from the **cdnvideo*[deployId]*** endpoint that you copied earlier in the lab, and then selec **OK**.
...
1.  On the **CDN profile** blade, select the **cdnweb*[deployId]*** endpoint.

1.  On the **Endpoint** blade, copy the value of the **Endpoint hostname** text box.

1.  On the taskbar, right-click the **Microsoft Edge** icon or activate the shortcut menu, and then select **New window**.

1.  In the new browser window, go to the **Endpoint hostname** URL for the **cdnweb*[deployId]*** endpoint.
